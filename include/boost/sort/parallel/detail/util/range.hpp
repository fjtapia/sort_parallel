...
//-----------------------------------------------------------------------------
template <class Iter_t>
inline range<Iter_t> init(const range<Iter_t> &rng,
...
inline range<Value_t *>
    uninit_full_merge(const range<Value_t *> &dest, 
                      const range<Iter1_t> &src1,
                      const range<Iter2_t> &src2, Compare comp)
{   //------------------- metaprogramming -----------------------------------
    typedef typename iterator_traits<Iter1_t>::value_type type1;
    ...
    return range<Value_t *>(dest.first,
                            uninit_full_merge(src1.first, src1.last, src2.first,
                                              src2.last, dest.first, comp));
};
//
//---------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
template <class Iter1_t, class Iter2_t, class Compare>
void merge_flow(range<Iter1_t> rng1, 
                range<Iter2_t> rbuf,
