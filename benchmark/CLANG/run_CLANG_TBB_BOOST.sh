...
clang++ src/benchmark_CLANG_TBB_BOOST.cpp -std=c++11  -w -fexceptions -fopenmp -O3 -I../../include -I../include   -pthread -fopenmp -s  -lpthread -ltbb  -o benchmark_CLANG_TBB_BOOST
echo "R U N N I N G . . . . . . . . ."
./file_generator input.bin 25000000
./benchmark_CLANG_TBB_BOOST >Results_CLANG.txt
rm input.bin
rm file_generator
rm benchmark_CLANG_TBB_BOOST
echo "."
