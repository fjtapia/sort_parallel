...
g++ src/benchmark_GCC_BOOST.cpp -std=c++11 -D_GLIBCXX_USE_SCHED_YIELD -w -fexceptions -fopenmp -O3 -I../../include -I../include -pthread -fopenmp -s  -lpthread   -o benchmark_GCC_BOOST
echo "R U N N I N G . . . . . . . . ."
./file_generator input.bin 25000000
./benchmark_GCC_BOOST >Results_GCC.txt
rm input.bin
rm file_generator
rm benchmark_GCC_BOOST
echo "."
