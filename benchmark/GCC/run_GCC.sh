...
g++ src/benchmark_GCC.cpp -std=c++11 -D_GLIBCXX_USE_SCHED_YIELD -w -fexceptions -fopenmp -O3 -I../../include -I../include -pthread -fopenmp -s  -lpthread   -o benchmark_GCC
echo "R U N N I N G . . . . . . . . ."
./file_generator input.bin 25000000
./benchmark_GCC >Results_GCC.txt
rm input.bin
rm file_generator
rm benchmark_GCC
echo "."
